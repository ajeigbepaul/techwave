...
const WorkedWith: React.FC = () => {
  return (
    <section className="w-full h-[30vh] bg-[#F8F8F8]">
      <div className="w-full max-w-6xl mx-auto h-full md:px-0 px-4 ">
        <div className="w-full flex items-center space-x-2 justify-center h-full">
          <div className="md:w-[17%] w-[50%] bg-white rounded-2xl border-l-4 p-6 border-l-brandcolor text-lg font-medium text-black">
            Worked with Leading Clients
          </div>
          <div className="md:w-[80%] w-[50%] h-[30vh]">
            <Swiper
              slidesPerView={5}
              centeredSlides={true}
              spaceBetween={30}
